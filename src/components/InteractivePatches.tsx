...
export default function InteractivePatches() {
  return (
    <svg viewBox="0 0 1620 1080" preserveAspectRatio="xMidYMid slice">
      ...
      <Link href="https://drive.google.com/file/d/1gMn9RTJeB4Yf9pdz9AKnXc66aIHU3MYs/view?usp=sharing" id="resume-link" className="patch-link" target="_blank" rel="noopener noreferrer">
        <g className="patch-group">
          <polygon 
            className="patch" 
      ...
      <Link href="" id="job-link" className="patch-link">
        <g className="patch-group">
          <polygon
            className="patch"
      ...
      <Link href="" id="placeholder2-link" className="patch-link">
        <g className="patch-group">
          <polygon
            className="patch"
            points="287,962.5 299,1077.5 514,1077.5 514,962.5 504.5,856.5 396.5,843.5 299,843.5 287,962.5"
          />
          <text x="400" y="920" className="patch-text">2</text>
        </g>
      </Link>

      <Link href="" id="placeholder3-link" className="patch-link">
        <g className="patch-group">
          <polygon
            className="patch"
            points="728,912.5 519,865 519,1073 701.5,1073 728,912.5"
          />
          <text x="600" y="950" className="patch-text">3</text>
        </g>
      </Link>

      <Link href="" id="placeholder4-link" className="patch-link">
        <g className="patch-group">
          <polygon
            className="patch"
            points="959.5,671.5 833.5,689.5 804,818.5 795.5,854.5 738.5,892.5 720.5,982.5 883.5,906.5 938,783 959.5,671.5"
          />
          <text x="850" y="800" className="patch-text">4</text>
        </g>
      </Link>

      <Link href="" id="placeholder5-link" className="patch-link">
        <g className="patch-group">
          <polygon
            className="patch"
            points="942,779.5 885.5,904 924.5,893 986,1072.5 1109,1072.5 1068,764 942,779.5"
          />
          <text x="1020" y="800" className="patch-text">5</text>
        </g>
      </Link>

      <Link href="" id="placeholder6-link" className="patch-link">
        <g className="patch-group">
          <polygon
            className="patch"
            points="1231.5,918 1231.5,1072.5 1112,1072.5 1096,927.5 1231.5,918"
          />
          <text x="1150" y="950" className="patch-text">6</text>
        </g>
      </Link>

      <Link href="" id="placeholder7-link" className="patch-link">
        <g className="patch-group">
          <polygon
            className="patch"
